...
export default ({loc}) => {
	return (
		...
		<style jsx>{`
			...
			span{
				font-family: -apple-system,BlinkMacSystemFont,Segoe UI, Lato, Roboto, Oxygen,Ubuntu,Cantarell,Fira Sans,Droid Sans,"Times New Roman",Helvetica Neue, sans-serif;
				font-size: 14px;
				margin: 0;
				margin-right: 10px;
				color: #1e1e1e;
